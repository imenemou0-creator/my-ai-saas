      ...
      <main className="pt-32 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-xl mx-auto">
            ...
            {isAnalyzing && (
              <div className="p-8 rounded-2xl border border-slate-800 bg-slate-900/50 animate-in fade-in zoom-in-95 duration-300">
            ...
            {showResult && (
              <div className="p-8 rounded-3xl border border-indigo-500/30 bg-indigo-500/5 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-8 duration-700 text-left">
                ...
                <div className="pt-8 border-t border-slate-800">
                  ...
                  <form className="flex flex-col sm:flex-row gap-3" onSubmit={(e) => { e.preventDefault(); alert('Rapport envoyé !'); }}>
                    <input 
                      type="email" 
                      value={email}
                      ...
                      required
                    />
                    <button className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-6 py-3 rounded-xl transition-all shadow-lg shadow-indigo-500/20">
                      <span>Obtenir le rapport complet</span>
